...
export default function HowItWorks() {
    return (
        <div style={{ textAlign: "center" }}>
            <div style={{ color: "white", fontSize: "40px", fontWeight: "700", marginBottom: "40px" }}>
                How It Works
            </div>
                ...
                <div className={styles.howItWorksLandingOuter}>
                    <div className={styles.howItWorksLandingInner}>
                        <div className={styles.howItWorksPanel}>
                            <h1 style={{ fontWeight: "700" }}>Start</h1>
                            <FontAwesomeIcon className={styles.howItWorksIcon} icon={["fas", "lightbulb"]} size="6x" transform="shrink-4" />
                        ...
                        <div className={styles.howItWorksPanel}>
                            <h1 style={{ fontWeight: "700" }}>Seed</h1>
                    ...
                    <div className={styles.howItWorksLandingInner}>
                        <div className={styles.howItWorksPanel}>
                            <h1 style={{ fontWeight: "700" }}>Progress</h1>
                        ...
                        <div className={styles.howItWorksPanel}>
                            <h1 style={{ fontWeight: "700" }}>Finish</h1>
