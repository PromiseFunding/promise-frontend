        ...
        <>
            <div id="faq">
                ...
                <Accordion expanded={expanded === "panel2"} onChange={handleChange("panel2")}>
                    ...
                    <AccordionDetails>
                        <Typography>
                            Milestone based funding allows donors to hold projects accountable as
                            the pledged donations are only made available to the project if the
                            donors vote in favor at the end of the milestone period. This mechanism
                            allows for donors to donate to the current milestone round or spread
                            the donation evenly across each milestone. If the donors vote against
                            the project, then the funds promised to the remaining milestones are
                            made available for withdrawal for the donors, therefore providing extra
                            protection for donors. Milestone based funding is also perfect for
                            early startups or projects looking to get funding without having to
                            give up equity, while building an early community of donors that helped
                            contribute to their success and proving their teams ability to make and
                            meet their goals.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                ...
                <Accordion expanded={expanded === "panel4"} onChange={handleChange("panel4")}>
                    ...
                    <AccordionDetails>
                        <Typography>
                            The owner of the project can call a maximum of 2 votes prior to the end
                            of the milestone period. Each voting period is a minimum of a week to
                            make sure donors and project owners can discuss and share their
                            thoughts and progress and come to a decision. If the amount of
                            &apos;Yes&apos; votes is greater or equal to the amount of
                            &apos;No&apos; votes, the project met its milestone goals and gains
                            access to the funds raised for that round. If an owner called for 2
                            votes and they both failed, the milestone did not meet its goal and the
                            fundraiser has ended. If the owner has called for less than 2 votes
                            prior to the end of the milestone period, then anyone can start a vote
                            and the result of that vote is final. A successful vote immediately
                            starts the next milestone round if it exists.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion expanded={expanded === "panel5"} onChange={handleChange("panel5")}>
                    ...
                    <AccordionDetails>
                        <Typography>
                            At the end of the Seed Funding Round, all the funds raised are made
                            available for the fundraiser to withdraw. Once the owner withdrawals,
                            the milestone rounds begin. At the end of each round, the vote
                            determines who can withdraw their funds. A vote in favor of the
                            fundraiser, allows the owner to withdraw the funds raised for that
                            round. A vote against the fundraiser allows each donor to withdraw the
                            amount they donated to that current milestone and any remaining
