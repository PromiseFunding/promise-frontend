            ...
            <div className={styles.howItWorksContainer}>
                <div className={styles.tutorialPanel}>
                    ...
                    <div className={styles.tutorialText} >
                        <div>
                            <h1 className={styles.howItWorksPanelTitle}>It starts with an idea</h1>
                ...
                <div className={styles.tutorialPanel}>
                    <div className={styles.tutorialText} >
                        <div>
                            <h1 className={styles.howItWorksPanelTitle}>Determine a timeline</h1>
                ...
                <div className={styles.tutorialPanel}>
                    ...
                    <div className={styles.tutorialText} >
                        <div>
                            <h1 className={styles.howItWorksPanelTitle}>Agree on the terms of the fundraiser</h1>
                ...
                <div className={styles.tutorialPanel}>
                    <div className={styles.tutorialText} >
                        <div>
                            <h1 className={styles.howItWorksPanelTitle}>Work towards goals</h1>
                ...
                <div className={styles.tutorialPanel}>
                    ...
                    <div className={styles.tutorialText} >
                        <div>
                            <h1 className={styles.howItWorksPanelTitle}>Accountability Voting</h1>
                ...
                <div className={styles.tutorialPanel}>
                    <div className={styles.tutorialText} >
                        <div>
                            <h1 className={styles.howItWorksPanelTitle}>Success!</h1>
